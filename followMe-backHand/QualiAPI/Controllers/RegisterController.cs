    ...
    [HttpGet]
        ...
        public async Task<IHttpActionResult> register()
        {
            ...
            List<UserProfile> users = new List<UserProfile>()
            {
                ...
                new UserProfile(){Email="c0556777462@gmail.com",FirstName="נחמה",Image="",LastName="חפץ",Marker=new Marker(){lat=32,lng=34.45,name="נחמה חפץ 0527680286"},Phone="0527680286",Status=true,UserMessageNeedGet=new List<DAL.Models.MessageUser>()},
                new UserProfile(){Email="c0556777462@gmail.com",FirstName="אברהם",Image="",LastName="חן",Marker=new Marker(){lat=32.44545,lng=34.2323,name="אברהם חן 0548478785"},Phone="0548478785",Status=true,UserMessageNeedGet=new List<DAL.Models.MessageUser>()},
                new UserProfile(){Email="c0556777462@gmail.com",FirstName="שרה",Image="",LastName="בן חמו",Marker=new Marker(){lat=32.44545,lng=34,name="שרה בן חמו 0504187965"},Phone="0504187965",Status=true,UserMessageNeedGet=new List<DAL.Models.MessageUser>()},
                new UserProfile(){Email="c0556777462@gmail.com",FirstName="טובה",Image="",LastName="כהן",Marker=new Marker(){lat=33,lng=35.09,name="טובה כהן 0527851111"},Phone="0527851111",Status=true,UserMessageNeedGet=new List<DAL.Models.MessageUser>()},
                new UserProfile(){Email="c0556777462@gmail.com",FirstName="אנה",Image="",LastName="בן שלום",Marker=new Marker(){lat=32.01,lng=34.01,name="אנה בן שלום 0508899245"},Phone="0508899245",Status=true,UserMessageNeedGet=new List<DAL.Models.MessageUser>()},
                new UserProfile(){Email="c0556777462@gmail.com",FirstName="טל",Image="",LastName="יברוב",Marker=new Marker(){lat=32.12,lng=34.12,name="טל יברוב 05578121212"},Phone="05578121212",Status=true,UserMessageNeedGet=new List<DAL.Models.MessageUser>()},
